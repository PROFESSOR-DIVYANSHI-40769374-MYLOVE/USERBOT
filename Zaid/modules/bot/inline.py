...
<b> • 𝐏𝐑𝚯𝐅𝐄𝐒𝐒𝚯𝐑 :</b> {message.from_user.mention}
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("──「 𝐏𝐑𝚯𝐅𝐄𝐒𝐒𝚯𝐑 𝚂ʌŋᴀᴛᴎɩ 」──", callback_data="helper")]]
            ),
        )
    )
    return answers
...
async def help_function(answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/205f3cf027a5a11f5f70e.jpg",
            input_message_content=InputTextMessageContent(
